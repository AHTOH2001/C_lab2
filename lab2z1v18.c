    ...
    while (true) {
        ...
        if (o == '1') {
            ...
            for (i = 0; i < n; i++) {
                ...
                else printf("Internet(MB): %lf\n", a[i][0]);
                printf("Cost of 1 over used MB: %lf\n", a[i][1]);
                if (a[i][2] == -1) printf("Unlimited minutes within Velcome\n");
                else printf("Minutes within velcome: %lf\n", a[i][2]);
                if (a[i][3] == -1) printf("Unlimited minutes to other networks\n");
                else printf("Minutes to other networks: %lf\n", a[i][3]);
                if (a[i][4] == -1) printf("Unlimited SMS\n");
                else printf("SMS count: %lf\n", a[i][4]);
                if (a[i][5] == -1) printf("Unlimited MMS\n");
                else printf("MMS count: %lf\n", a[i][5]);
